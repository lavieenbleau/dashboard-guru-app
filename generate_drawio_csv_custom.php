...
$csv = "## Draw.io CSV Import untuk ERD Chen's Notation (Custom Horizontal Flow)\n";
$csv .= "# label: %name%\n";
$csv .= "# style: shape=%shape%;whiteSpace=wrap;html=1;\n";
$csv .= "# namespace: csvimport_\n";
$csv .= "# connect: {\"from\": \"parent\", \"to\": \"id\", \"style\": \"endArrow=none;html=1;edgeStyle=orthogonalEdgeStyle;curved=1;\", \"label\": \"%edgeLabel%\"}\n";
$csv .= "# connect: {\"from\": \"parent2\", \"to\": \"id\", \"style\": \"endArrow=none;html=1;edgeStyle=orthogonalEdgeStyle;curved=1;\", \"label\": \"%edgeLabel2%\"}\n";
$csv .= "# layout: horizontalflow\n"; // Using horizontalflow automatically places nodes from left to right.
...
foreach ($data as $model => $info) {
    ...
    foreach ($info['relations'] as $relName => $rel) {
        ...
        $nodes[] = "$relId,memiliki,rhombus,E_$table1,$card1,E_$table2,$card2";
    }
}

$csv .= implode("\n", $nodes);
file_put_contents('C:\Users\faisa\.gemini\antigravity-ide\brain\1d48db67-5db4-458f-87cd-ad554db006ec\drawio_chen_erd_custom.csv', $csv);
echo "DONE!";
