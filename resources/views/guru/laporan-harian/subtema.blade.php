            ...
            <div class="col-md-6 col-lg-4 mb-3">
                <div class="card h-100 hover-card">
                    <div class="card-body">
                        ...
                        <a href="{{ route('guru.laporanharian.list', [$serial->id, $mapel->id, $tema->id, $subtheme->id]) }}" class="btn btn-dark btn-sm w-100">
                            <i class='bx bx-file-find me-1'></i>Lihat Laporan Harian
                        </a>
                    </div>
                </div>
            </div>
