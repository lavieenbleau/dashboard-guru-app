...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="d-flex align-items-center justify-content-between mb-4">
        <h4 class="mb-0 fw-bold text-dark"><i class='bx bx-book-open text-primary me-2'></i>Tambah Materi Baru</h4>
    </div>
                ...
                <div class="card card-modern h-100">
                    <div class="card-body p-4">
                        <div class="mb-4">
                            ...
                            <input type="text" name="title" class="form-control form-control-lg @error('title') is-invalid @enderror" value="{{ old('title') }}" placeholder="Contoh: Mengenal Sistem Tata Surya" required>
                            @error('title')
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="description" id="editor" class="form-control summernote @error('description') is-invalid @enderror">{{ old('description') }}</textarea>
                            @error('description')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="mb-2">
                            <label class="form-label fw-bold text-dark">Lampiran Materi</label>
                            <!-- Input File Hidden -->
            ...
            <div class="col-lg-4 mb-4">
                ...
                <div class="card card-modern mb-4">
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="mb-2">
                            ...
                            <textarea name="embed" id="embedInput" rows="3" class="form-control @error('embed') is-invalid @enderror" placeholder="<iframe src='...'></iframe>">{{ old('embed') }}</textarea>
                            @error('embed')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                ...
                <div class="d-flex flex-column gap-2 mt-4">
                    <button type="submit" class="btn btn-primary btn-lg shadow-sm fw-bold w-100">
                        <i class='bx bx-save me-2'></i>Simpan Materi
                    </button>
