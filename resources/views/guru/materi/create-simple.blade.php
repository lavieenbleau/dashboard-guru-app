        ...
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">Tambah Materi Baru - {{ $mapel->name }}</h5>
                    <a href="{{ route('guru.materi.mapel', [$serial->id, $mapel->id]) }}" class="btn btn-sm btn-outline-secondary">
                        <i class='bx bx-arrow-back'></i> Kembali
                    </a>
                </div>
                <div class="card-body">
                    <form action="{{ route('guru.materi.store', [$serial->id, $mapel->id]) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <!-- Attachment -->
                        <div class="mb-3">
                            <label class="form-label">File Lampiran <small class="text-muted">(Optional)</small></label>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="embed" class="form-control @error('embed') is-invalid @enderror" rows="3" placeholder="<iframe src='...'></iframe>">{{ old('embed') }}</textarea>
                        ...
                        <div class="d-flex justify-content-end gap-2 mt-4">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class='bx bx-save'></i> Simpan Materi
                            </button>
                        </div>
                    </form>
                </div>
