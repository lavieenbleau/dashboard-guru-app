...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="d-flex align-items-center justify-content-between mb-4">
        <h4 class="mb-0 fw-bold text-dark"><i class='bx bx-book-open text-primary me-2'></i>Tambah Materi Baru - {{ $lesson->name }}</h4>
    </div>

    <form action="{{ route('guru.materi.store', [$serial->id, $lesson->id]) }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="row">
