...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="d-flex align-items-center justify-content-between mb-4">
        <h4 class="mb-0 fw-bold text-dark"><i class='bx bx-book-open text-primary me-2'></i>Edit Materi</h4>
    </div>
        ...
        <div class="row">
                ...
                <div class="card card-modern h-100">
                    <div class="card-body p-4">
                        <div class="mb-4">
                            ...
                            @endphp
                            <input type="text" name="title" class="form-control form-control-lg @error('title') is-invalid @enderror" value="{{ old('title', $title) }}" placeholder="Contoh: Mengenal Sistem Tata Surya" required>
                            @error('title')
                        ...
                        <div class="mb-4">
                            ...
                            @endphp
                            <textarea name="description" id="editor" class="form-control summernote @error('description') is-invalid @enderror">{{ old('description', $description) }}</textarea>
                            @error('description')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="mb-2">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="alert alert-info mb-2 p-2 d-flex align-items-center">
                                    ...
                                    <a href="{{ Storage::url($currentAttachment) }}" target="_blank" class="text-truncate">{{ basename($currentAttachment) }}</a>
                                </div>
                            </div>
                            @endif

                            <label class="form-label fw-bold text-dark">{{ $currentAttachment ? 'Ganti File Lampiran' : 'Upload Lampiran' }}</label>
                            <!-- Input File Hidden -->
            ...
            <div class="col-lg-4 mb-4">
                    ...
                    <div class="card-body p-4">
                        <div class="mb-4">
                            ...
                            <div class="input-group input-group-merge">
                                ...
                                @endphp
                                <input type="url" name="link" class="form-control @error('link') is-invalid @enderror" value="{{ old('link', $link) }}" placeholder="https://...">
                            </div>
                            @error('link')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="mb-2">
                            ...
                            @endphp
                            <textarea name="embed" id="embedInput" rows="3" class="form-control @error('embed') is-invalid @enderror" placeholder="<iframe src='...'></iframe>">{{ old('embed', $embed) }}</textarea>
                            @error('embed')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                ...
                <div class="card card-modern mb-4">
                    ...
                    <div class="card-body p-4">
                        <div class="mb-4">
                            <label class="form-label fw-bold text-dark">Tipe Materi <span class="text-danger">*</span></label>
                        ...
                        <div class="mb-4">
                            <label class="form-label fw-bold text-dark">Mata Pelajaran (Opsional)</label>
                        ...
                        <div class="mb-2">
                            <label class="form-label fw-bold text-dark">Kategori Kelas</label>
                            @php
                            ...
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                            <small class="text-muted d-block mt-1">Pilih kelas/kategori target materi ini.</small>
                        </div>
                    </div>
                </div>
                ...
                <div class="d-flex flex-column gap-2 mt-4">
                    ...
                    <a href="{{ route('guru.materi.list', [$serial->id, $tema->id, $subtema->id, $type]) }}" class="btn btn-label-secondary btn-lg fw-bold w-100">
                        Batal
                    </a>
                </div>
